...
def query_station_status(url):
    ...
    # Create separate columns for bike types based on actual data structure
    df['ebike'] = df['num_ebikes_available']  # Electric bikes
    df['mechanical'] = df['num_bikes_available'] - df['num_ebikes_available']  # Mechanical bikes (total - electric)
